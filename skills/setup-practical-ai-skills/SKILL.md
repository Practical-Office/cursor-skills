---
name: setup-practical-ai-skills
description: Sets up an `## Agent skills` block in AGENTS.md/CLAUDE.md and `docs/agents/` so Practical Office engineering skills know this repo's issue tracker (GitHub default), triage label vocabulary, and domain doc layout. Run once per application repo before first use of `to-issues`, `to-prd`, `triage`, `diagnose`, `tdd`, `improve-codebase-architecture`, or `zoom-out`.
